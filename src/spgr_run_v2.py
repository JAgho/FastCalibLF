...
from fast_cal_analysis import fast_cal_analysis
...
def main():
    ...
    for i in range(n_calibs):
        ...
        fast_cal_analysis(hybrid,fov=params["fov"],te_1=params["te_1"],te_2=params["te_2"],
                          tr_2_factor=params["tr_2_factor"],snr_threshold=2,
                          output_png="fast_calibration.png")
